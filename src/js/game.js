...
//     });
    ...
    class Buffer{
        ...
        loadingSound(url,index){
            ...
            var thisBuffer = function(){
                this.buffer.context.decodeAudioData(request.response, function (buffer) {
    ...
    function playSound(e) {
        ...
        var buffer = new Buffer(context, ["https://s3-us-west-2.amazonaws.com/s.cdpn.io/327091/11.wav"]);
        buffer.loadAll();
